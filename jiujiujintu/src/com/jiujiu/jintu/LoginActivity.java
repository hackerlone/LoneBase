...
public class LoginActivity extends Activity {
	...
	public void btnOnClick(View view) {
		...
		case R.id.login_btn_jiujiu://点击久久账户登录
			...
			jiujiubtnView.setBackgroundResource(R.drawable.bg_left_corner_green_5dp);
			dynamicbtnView.setBackgroundResource(R.drawable.bg_right_green_stroke_corner_5dp);
			return;
		case R.id.login_btn_dynamic://点击动态密码
			...
			jiujiubtnView.setBackgroundResource(R.drawable.bg_left_green_stroke_corner_5dp);
			dynamicbtnView.setBackgroundResource(R.drawable.bg_right_corner_green_5dp);
			return;
