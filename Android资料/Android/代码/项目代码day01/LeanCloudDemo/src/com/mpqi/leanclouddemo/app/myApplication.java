...
import com.mpqi.leanclouddemo.bean.Post;
...
public class myApplication extends Application {
	...
	public void onCreate() {
		...
		// try {
		// Post post = AVObject.createWithoutData(Post.class,
		// "56497e4b00b0ee7f5993bf4c");
		// } catch (AVException e) {
	...
	private void selectPost() {// 子类化的查询
	...
	private void selectEqualTo() {// 使用条件匹配 进行关系查询
		AVObject myPost = AVObject.createWithoutData("Post",
				"564949b200b0d1db33734b33");
