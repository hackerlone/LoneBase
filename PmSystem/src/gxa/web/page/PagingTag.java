...
public class PagingTag extends TagSupport{
	...
	{	
		...
		navigation.append("&nbsp;&nbsp;<li>[第"+currentPage+"页/共"+totalPages+"页]&nbsp;&nbsp;</li>");
		if (currentPage<=1){
//		  navigation.append("首页");
//		  navigation.append("&nbsp;");
//		  navigation.append("上一页");
		} else {
		  navigation.append("<li><a href='"+href+"&offset=0&pageSize="+pageSize+"'>首页</a></li>");
		  navigation.append("&nbsp;");
		  navigation.append("<li><a href='"+href+"&offset="+(offset-pageSize)+"&pageSize="+pageSize+"'>上一页</a></li>");
		}
		navigation.append("&nbsp;");
...
//		  navigation.append("尾页");
		  ...
		  navigation.append("<li><a href='"+href+"&offset="+(offset+pageSize)+"&pageSize="+pageSize+"'>下一页</a></li>");
		  navigation.append("&nbsp;");
		  navigation.append("<li><a href='"+href+"&offset="+((totalPages-1)*pageSize)+"&pageSize="+pageSize+"'>尾页&nbsp;</a></li>");
		}
		navigation.append("&nbsp;");
		try {
