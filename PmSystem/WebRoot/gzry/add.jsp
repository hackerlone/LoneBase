...
#formdiv{width:600px;text-align:left;margin-left:auto;margin-right:auto; margin-top:auto; margin-bottom:auto;}
 ...
 #formreg div{color:red;float:right;text-align:center;}
  ...
  <body>
    <div align="center"><font size="14">工作人员信息添加 </font></div><br />
  <div class="widget">
...
<form action="GzryS?option=processAdd" method="post" id="formreg">
 员工编号： <input type="text" size="30" name="gz_bianhao" alt="业主编号" value="${gzbianhao }"   readonly="readonly"><div></div><br/>
 物管编号：  <select name="w_id" >
		<c:forEach var="wgxx" items="${wgxxs}" >
		<option value=${wgxx.w_id } >${wgxx.w_xm}</option> 
		</c:forEach></select>
 <div></div><br/><br/>
 在职状态：  <input type="text" size="30" name="gz_qk" alt="业主年龄" ><div></div><br/>
 工作时间：  <input type="text" size="30" name="gz_nb" id="popupDatepicker" alt="业主住址"><div></div><br/>
