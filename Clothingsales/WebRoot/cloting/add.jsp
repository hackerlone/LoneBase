...
<div id="body-wrapper">
  ...
  <div id="main-content">
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div id="formreg">
          <form action="ClotingS?option=processAdd" method="post" id=form>
          <table border="5">
         
          <tr>
          <td>
	             服装编号：</td><td><input name="f_id" type="text" value="${fid}" alt="服装编号"/><div></div></td> </tr>
	  <tr>
		<td>供应商：</td><td>
		<select name="s_id" >
		<c:forEach var="supperi" items="${suppiers}" >
		<option value=${supperi.s_id } >${supperi.s_name}</option> 
		</c:forEach></select></td></tr>
		<tr><td>
		品牌编号：</td><td><input name="f_pid" type="text" alt="品牌编号" /><div></div></td></tr>
		<tr><td>
	            服装名称：</td><td><input name="f_name" type="text" alt="服装名称" /><div></div></td></tr>
	            <tr><td>
		品牌名称：</td><td><input name="f_brand" type="text" alt="品牌名称" /><div></div></td></tr>
		<tr><td>
		服装尺寸：</td><td>
		 <select name="f_model" >
		...
		<tr><td>
		服装销售价格：</td><td><input name="f_price" type="text" alt="服装销售价格" /><div></div></td></tr>
		<tr><td>
		服装进价：</td><td><input name="f_bid" type="text"  /></td></tr>
		<tr><td>
		服装数量：</td><td><input name="f_number" type="text" alt="服装数量" /><div></div></td></tr>
		<tr><td>
    ...
    <form action="FileUpS?url=ClotingS?option=add" method="post" enctype="multipart/form-data">
