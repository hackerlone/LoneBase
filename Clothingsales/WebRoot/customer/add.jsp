      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div id="formreg">
           ...
           <form action="CustomerS?option=processAdd" method="post" id=form >
 <table border="5">
 <tr><td>
 客户编号：</td><td><input type="text" size="20" name="k_id" alt=" 客户编号" /><div></div></td></tr>
 <tr><td>
 客户积分：</td><td>  <input type="text" size="20" name="k_integ" alt="客户积分" /><div></div></td></tr>
 <tr><td>
 客户姓名：</td><td>  <input type="text" size="20" name="k_name" alt="客户姓名" /><div></div></td></tr>
 <tr><td>
 客户密码：</td><td>  <input type="text" size="20" name="k_pwd" alt="客户密码" /><div></div></td></tr>
 <tr><td>
购买数量： </td><td> <input type="text" size="20" name="k_number" alt="购买数量" /><div></div></td></tr>
<tr><td>
 联系方式：  </td><td><input type="text" size="20" name="k_tel" alt="联系方式" /><div></div></td></tr>
 <tr><td>
客户退货：</td><td>  <input type="text" size="20" name="k_return"  alt="客户退货" /><div></div></td></tr>
<tr><td>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
