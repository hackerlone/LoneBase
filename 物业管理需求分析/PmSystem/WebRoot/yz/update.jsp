...
<form action="YzS?option=processUpdate" method="post" id="formreg">
  业主编号： <input type="text" size="30" name="o_id" alt="业主编号" value="${yz.o_id }"  readonly="readonly"><div></div><br/>
 业主姓名：  <input type="text" size="30" name="o_xm" alt="业主姓名" value="${yz.o_xm }"><div></div><br/>
 业主年龄：  <input type="text" size="30" name="o_nl" alt="业主年龄" value="${yz.o_nl }"><div></div><br/>
 业主住址：  <input type="text" size="30" name="o_jtzz" alt="业主住址" value="${yz.o_jtzz }"><div></div><br/>
 身份证号：  <input type="text" size="30" name="o_sfzhm" alt="身份证号" value="${yz.o_sfzhm }"><div></div><br/>
 入住时间：  <input type="text" size="30" name="o_rzsj" alt="入住时间" id="popupDatepicker" readonly="readonly" value="${yz.o_rzsj }"><div></div><br/>
 联系方式：  <input type="text" size="30" name="o_lxfs" alt="联系方式" value="${yz.o_lxfs }"><div></div><br/>
 用户密码：<input  type="text" size="30" name="o_pwd" alt="联系方式" value="${yz.o_pwd }"><div></div><br/>
 住房编号：  <select name="w_id" >
