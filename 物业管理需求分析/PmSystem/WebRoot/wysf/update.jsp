...
#formdiv{width:600px;text-align:left;margin-left:auto;margin-right:auto; margin-top:auto; margin-bottom:auto;}
 ...
 #formreg div{color:red;float:right;text-align:center;}
  ...
  <body>
    <div align="center"><font size="14">收费信息修改 </font></div><br />
  <div class="widget">
...
<form action="WysfS?option=processUpdate" method="post" id="formreg">
 流水帐号：  <input type="text" size="30" name="sh_id" alt="流水账号" value="${wysf.sh_id }"  readonly="readonly"><div></div><br/>
 实收金额：  <input type="text" size="30" name="sh_zl" alt="实收金额" value="${wysf.sh_zl }"><div></div><br/>
 标准价格：  <input type="text" size="30" name="sh_bzjg" alt="标准价格" value="${wysf.sh_bzjg }"><div></div><br/>
 收取时间：  <input type="text" size="30" name="sh_time" alt="收取时间" id="popupDatepicker" readonly="readonly" value="${wysf.sh_time }"><div></div><br/>
 费用类别：  <input type="text" size="30" name="sh_leibie" alt="费用类别" value="${wysf.sh_leibie }"><div></div><br/>
业主姓名：  
		<select name="o_id" >
