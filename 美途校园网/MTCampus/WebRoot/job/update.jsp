...
<html xmlns:wb="http://open.weibo.com/wb" lang="zh-CN">
	...
	<body>
		<s:action name="jz_secjobforvita" executeResult="false">
			<s:param name="jz.job.ZId">
				<s:property value="job.ZId" />
			</s:param>
			<s:param name="option">secvita</s:param>
		</s:action>
			...
			<div id="header">
				<div id="header_content">
					...
					<ul id="item_box">
						...
						<li class="active">
							<a href=
"qy_getEnterpriseById.action?enterprise.QId=${session.enterprise.QId}&option=updata" class="header_href">个人中心</a>
						</li>
						<li>
							<a href="/topic" target="_blank" class="header_href">活动</a>
						</li>
						<li>
							<a href="http://more.shixiseng.com/" target="_blank"
					...
					<dl id="log_user">
						<dt id="user_name">
						${session.students.UName}${session.enterprise.QName}
							<span class="redstar"></span>
						</dt>


						<dd class="user_nav">
							<a href="qy_getEnterpriseById.action?enterprise.QId=${session.enterprise.QId}&option=updata">个人中心<span class="redstar"></span> </a>
						</dd>
						<dd class="user_nav">
 ...
 头像：<img id="headimg" src="upload/<s:property value="student.UTouxiang"/>"/>
   ...
   -->
    ...
    职业编号:<s:property value="job.ZId" />
								<br />
   编号 <s:property value="job.enterprise.QId"/>
								<br />
								<s:textfield name="job.ZName" label="职位名称" />
								<s:textfield name="job.ZArea" label="工作地点" />
								<s:textfield name="job.ZRenshu" label="招聘人数" />
								<s:textfield name="job.ZZhineng" label="职位要求" />
								<br />
								<s:textfield name="job.ZMiaoshu" label="职位描述" />
								<br />
								<s:textfield name="job.ZXinzi" label="薪资" />
								<br />
								<s:hidden id="face" name="job.JFace"></s:hidden>
								求职时间：<input name="job.ZDate"
									value="<s:property value="job.ZDate"/>" type="text"
...
>
							...
							有简历
							<s:property value="#request.vitass.size" />
							份已投递
							<br />
							<s:if test="#session.enterprise.QName!=null">
								<table align="center" border="1">
									<tr>
										...
										<s:iterator value="#request.vitass" var="vitass">
											<td>
												<a
													href="/MTCampus/vit_getVitaById.action?id=<s:property value="#vitass.vita.JId" />&option=update">查看编号为<s:property
														value="#vitass.vita.JId" />的简历</a>
											</td>
										</s:iterator>
									</tr>
									<tr>
										...
										<s:iterator value="#request.jzss" var="jzs">
											<td>
												<s:property value="#jzs.TDate" />
											</td>
										</s:iterator>
									</tr>
								</table>
