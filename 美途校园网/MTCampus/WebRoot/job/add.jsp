...
<li  class="active" >
<a href="qy_getEnterpriseById.action?enterprise.QId=<s:property value="%{#request.enterprise.QId}"/>&option=updata" class="header_href">个人中心</a>
</li>
<li >
...
<dd class="user_nav"><a href="qy_getEnterpriseById.action?enterprise.QId=<s:property value="%{#request.enterprise.QId}"/>&option=updata">个人中心<span class="redstar"></span></a></dd>
...
<!--  
 头像：<img id="headimg" src="upload/<s:property value="student.UTouxiang"/>"/>
  ...
  <input type="text" name="ZId"
     ...
     职位名称：<input type="text" name="ZName" /><br />
    发布日期：<input name="ZDate" value="<s:property value="ZDate"/>" type="text" class="Wdate" 
           readonly id="Regemail" 
  tabindex="1"  onClick="WdatePicker()"></p>
