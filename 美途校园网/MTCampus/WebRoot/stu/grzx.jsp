...
<li  class="active" >
<a href="stu_getStudentById.action?student.UId=<s:property value="student.UId"/>&option=update" class="header_href">个人中心</a>
</li>
<li >
...
<!--已经登录 企业用户-->
<dl id="log_user">
<dt id="user_name">${session.students.UName}<span class="redstar"></span></dt>


<dd class="user_nav"><a href="stu_getStudentById.action?student.UId=<s:property value="student.UId"/>&option=update">个人中心<span class="redstar"></span></a></dd>
...
<div class="base_inf">
   ...
   <center>
   <img id="headimg1" src="upload/<s:property value="student.UTouxiang"/>"/>
<s:form action="stu_update">
<s:hidden  name="#request.student.UTouxiang"/>
    编号:<s:property value="student.UId"/><br/>
   <strong><s:textfield name="student.UName" label="姓名"/></strong>
...
出生日期：<input name="student.UBirthday" value="<s:property value="student.UBirthday"/>" type="text" class="Wdate" 
readonly id="Regemail" 
