...
<div class="base_inf">
 ...
 <s:hidden name="#request.student.UTouxiang"/>  
  ...
  <strong><s:property value="#request.student.UName"/></strong>
<p> <s:property value="#request.student.UBirthday"/>
 | <s:if test="#request.student.USex==1">女</s:if>
 <s:elseif test="#request.student.USex==0">男</s:elseif>
</p>
<p> <s:property value="#request.student.UPhone"/>
 | <s:property value="#request.student.UEmail"/> </p>
<s:if test="#session.students.UId==#request.student.UId">
       <a href="stu_getStudentById.action?student.UId=<s:property value="student.UId"/>&option=updata">个人信息修改</a>
 </s:if> 
   	<br/>
...
<i></i>
简历份数
<span class="view_item_num">(<s:property value="student.vitas.size"/>)</span>
</li>
...
<s:iterator value="#request.vitas" var="vita">          
          	  ...
          	  <a href="/MTCampus/vit_getVitaById.action?id=<s:property value="#vita.JId"/>&option=update">修改<s:property value="#vita.JId"/>号简历</a><br />
            	</li><br />
            </s:iterator>
...
简历删除：<br/>
            <s:iterator value="#request.vitas" var="vita">
             <li class="back_item" data-back="all">         
          	 <a href="MTCampus/vit_deleteVita.action?id=<s:property value="#vita.JId"/>&option=delete">删除<s:property value="#vita.JId"/>号简历</a><br />
            </li><br />
            </s:iterator>
</ul>
</s:if>
