...
<li  class="active" >
<a href="stu_getStudentById.action?student.UId=<s:property value="%{#request.student.UId}"/>&option=update" class="header_href">个人中心</a>
</li>
<li >
<a href="/topic" target="_blank" class="header_href">活动</a>
</li>
<li><a href="" target="_blank" class="header_href">加油站</a></li>
...
<!--已经登录 企业用户-->
<dl id="log_user">
<dt id="user_name">浩奇<span class="redstar"></span></dt>


<dd class="user_nav"><a href="stu_getStudentById.action?student.UId=<s:property value="%{#request.student.UId}"/>&option=update">个人中心<span class="redstar"></span></a></dd>
...
<s:form action="vit_addVita">
  ...
  <input type="text" name="JId"
				value="<s:property value="%{#request.maxidJId}"/>" readonly="readonly" /></p>
	实习生编号：<input type="text" name="UId" value="<s:property value="%{#request.student.UId}"/>" readonly="readonly"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	<br />	
		名称：<input name="student.UName" value="<s:property  value="%{#request.student.UName}"/>"/><br/>	
		    <s:hidden id="stusex" name="#request.student.USex"></s:hidden>
		     &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp 
		             性别：<select class="A" name="student.USex">
		...
		政治面貌：<select class="A" name="JFace">
	          <option value="群众">群众</option>
	          <option value="共青团员">共青团员</option>
	          <option value="预备党员">预备党员</option>
	          <option value="党员">党员</option>
              </select>&nbsp&nbsp&nbsp&nbsp&nbsp<br />	                      	
		...
		毕业学校：<input type="text" name="JByxx"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br />
		工作经历：<input type="text" name="JGzjl">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br />
		联系地址：<input type="text" name="JDizhi"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br />	
		&nbsp&nbsp&nbsp&nbsp&nbsp简介：<input class=B type="text" name="JJianjie"><br />
                      出生日期：<input name="request.student.UBirthday" value="<s:property value="request.student.UBirthday"/>" type="text" class="Wdate" 
             readonly id="Regemail" tabindex="1"  onClick="WdatePicker()">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
<div class="title">
<p>是否参加面试</p>
<img class="close_interview" src="/static/img/close.png?v=43ca279e203e75e1d574a03a9acb5e42" alt=""/>
</div>
<input type="hidden" class="guid_join" value=""/>
<div class="option">
<form>
<input type="radio" name="interview" id="punctual" value="normal" /><label for="punctual">准时参加</label>
<input type="radio" name="interview" id="delay" value="delay" /><label for="delay">延时参加</label>
<input type="radio" name="interview" id="abandon" value="reject" /><label for="abandon">放弃面试</label>
</form>
</div>
...
<div id="login_inf">
<form>
<input type="text" id="log_name" class="log_input" tabindex="1" placeholder="请输入手机号/邮箱"/>
<span class="error">此用户不存在</span>
<input type="password" id="log_password" class="log_input" tabindex="2" placeholder="请输入密码">
<span class="error">密码不正确</span>
<input type="button" id="login_btn" value="登 录">
<div class="login_jump">
<p class="not_user">
没有账号,直接
<span class="to_login f_col" onclick="jumpto('/user/register')">注册</span>
</p>
...
<a href="/user/sso/weibo/auth"
class="icon_wb" title="使用新浪微博帐号登录"></a>
<a href="/user/sso/qq/auth" class="icon_qq" title="使用腾讯QQ帐号登录"></a>
<a href="/user/sso/wechat/auth" class="icon_weixin" title="使用微信帐号登录"></a>
</div>
</div>
</div>
</div>
...
<p>中国领先的实习生招聘网站 &nbsp;&nbsp;&copy;2015 Shixiseng</p>
...
<a href="http://weibo.com/345952499" target="_blank">
<img src='../images/sina-icon.png' alt="实习僧微博"/>
</a>
<a id="weixin" href="javascript:;">
<img src="../images/weixin.png" alt="实习僧微信"/>
</a>
...
<input type="text" id="fb-email" name="fb_user" placeholder="留下邮箱方便我们沟通（必填）">
